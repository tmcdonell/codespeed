...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Benchmark.on_summary'
        db.add_column(u'codespeed_benchmark', 'on_summary',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Benchmark.on_summary'
        db.delete_column(u'codespeed_benchmark', 'on_summary')
    ...
    models = {
        u'codespeed.benchmark': {
            ...
            'on_summary': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
